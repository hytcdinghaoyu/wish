	...
	$.post("Home/index/getMsg",{count:count},function(data){
		...
		$.each(data,function(){
			if (this.status) {
				...
				str +='<span class="num">No.'+this.id+'</span>';
				str +='</dt><dd class="content">'+this.content+'</dd>';
				str +='<dd class="bottom"><span class="time">'+this.time+'</span>';
				str +='<span class="city">来自：'+this.city+'</span>';
				str +='<a href="" class="close"></a>';
				str +='</dd></dl>';
